...
public class ScrapperGrpcClientConfig {
    ...
    public ManagedChannel scrapperManagedChannel(ScrapperProperties scrapperProperties) {
        return ManagedChannelBuilder.forAddress(scrapperProperties.grpcHost(), scrapperProperties.grpcPort())
                .usePlaintext()
                .build();
    }
}
