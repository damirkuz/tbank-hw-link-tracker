...
public class ListTagsAllCallbackHandler implements CallbackHandler {
    ...
    public ListTagsAllCallbackHandler(
            TagKeyboardFactory tagKeyboardFactory,
            TelegramBot bot,
            LinkListService linkListService,
            BotProperties botProperties) {
        this.tagKeyboardFactory = tagKeyboardFactory;
        this.bot = bot;
        this.linkListService = linkListService;
        this.callbackKey = botProperties.tagKeyboard().callbackShowAll();
    }

    @Override
    public boolean supports(String callbackData) {
        return callbackKey.equals(callbackData);
    }
